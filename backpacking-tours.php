...
<body>
    <div class="container">
        ...
        <div class="image_header" style="background-image: url(img/3-min.png)"></div>
        <div class="breadcrumbs white-color">
            <div class="wrap">
                <div class="wrap_float">
                    <a href="#">Home</a>
                    <span class="separator">/</span>
                    <a href="#">Backpacking Tours</a>
                </div>
            </div>
        </div>
        <div class="page travel-list full-width full-width-image-header">
            ...
            <div class="page_body">
                <div class="wrap">
                    ...
                    $sql="SELECT * from productdemo where category='backpacking' ";
  ...
  <script type="text/javascript" id="hs-script-loader" async defer src="//js-na1.hs-scripts.com/22093778.js"></script>
